...
{: .info }
> While your server is offline, the MOTD is replaced with a message prompting players to start the server remotely. Disabling the [remote startup feature](/falix/dashboard/automation/external-start) will also disable this offline MOTD.
