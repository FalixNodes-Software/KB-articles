...
11. Scroll down to `player-info-forwarding-mode = ` (line 37) and change it to `"MODERN"` if all your fallback servers are 1.13 or above or `"legacy"` for servers below 1.13.
