...
keywords:
    - keyword: server name
      matches: ["change", "rename", "edit", "update"]
    - keyword: description
      matches: ["server", "change", "edit", "update"]
    - keyword: icon
      matches: ["server", "change", "edit", "update"]
    - keyword: crash notification
      matches: ["alert", "notify", "crash", "setting"]
author: Lily
---
...
2. On the **General** tab, click the **Server Name** card.
3. Type in your new name (up to 20 characters).
4. Click **Save**.
...
1. On the **General** tab, click the **Server Description** card.
2. Write your description (up to 255 characters).
3. Click **Save**.
...
1. On the **General** tab, click the **Server Icon** card.
2. Browse the icon grid and select one that fits your server.
3. Click **Save**.
...
1. On the **General** tab, find the **Crash Notifications** dropdown.
