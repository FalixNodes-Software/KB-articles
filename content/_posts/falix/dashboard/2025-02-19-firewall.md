...
tags: Server
permalink: falix/dashboard/general/firewall
...
- **Direction** -- Whether the rule applies to Inbound traffic, Outbound traffic, or both.
...
Firewall rules can't be edited in place. If you need to change a rule, just delete the old one and create a new one with the updated settings. It only takes a moment.
