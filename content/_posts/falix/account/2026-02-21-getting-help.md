...
keywords:
    - keyword: help
      matches: ["how", "ask", "get", "best"]
    - keyword: support
      matches: ["tips", "faster", "better", "effective"]
    - keyword: ticket
      matches: ["write", "good", "tips", "best practices"]
author: Lily
---
...
1. **Search the Knowledge Base** -- your question may already be answered. The [Knowledge Base](https://kb.falixnodes.net) covers common setup steps, billing questions, and troubleshooting guides.
...
4. **Check for known outages** -- if multiple servers are affected, there may be a platform-wide issue being worked on. Check the [Discord](https://discord.falixnodes.net) for announcements.
