...
keywords:
    - keyword: support
      matches: ["ticket", "help", "contact", "center"]
    - keyword: ticket
      matches: ["create", "open", "submit", "new"]
    - keyword: help
      matches: ["support", "contact", "issue", "problem"]
    - keyword: contact
      matches: ["support", "team", "staff", "help"]
author: Lily
---
...
A summary of everything you entered is shown. Double-check the details, then click **"Submit Ticket"**{: .green } to create your ticket.
...
5. Click **"Send"**{: .green } to post your reply.
...
When your issue is resolved, you can close the ticket by clicking the **"Close Ticket"**{: .red } button. If the issue comes back or you need further help, you can reopen a closed ticket at any time.
